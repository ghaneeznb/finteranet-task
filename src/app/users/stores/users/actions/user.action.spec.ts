...
describe('UsersActionTest', () => {
    describe('GetAllUsers', () => {
        ...
        it('should create an actionSuccess', () => {
            const type = GetUsersSuccessAction({ payload: [mockUser] });
            expect(type.payload).toEqual([mockUser]);
